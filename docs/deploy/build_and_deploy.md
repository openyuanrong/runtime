...
- Driver 程序中调用 `YR::Init(const Config &conf)` 接口时，配置 [Config](../multi_language_function_programming_interface/api/distributed_programming/zh_cn/Cpp/struct-Config.rst) 的 `loadPaths` 参数。
