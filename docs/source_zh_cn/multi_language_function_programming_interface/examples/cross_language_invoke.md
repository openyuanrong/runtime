...
我们将 C++ 无状态与有状态函数编译成动态库，在 Python 主程序中使用 [yr.cpp_function](../api/distributed_programming/Python/yr.cpp_function.rst) 和 [yr.cpp_instance_class](../api/distributed_programming/Python/yr.cpp_instance_class.rst) API 调用。
...
我们在 Python 主程序中使用 [yr.cpp_function](../api/distributed_programming/Python/yr.cpp_function.rst) 和 [yr.cpp_instance_class](../api/distributed_programming/Python/yr.cpp_instance_class.rst) API 调用 Java 无状态和有状态函数。
...
我们在 C++ 主程序中使用 [PyFunction](../api/distributed_programming/Cpp/PyFunction.rst) 和 [PyInstanceClass::FactoryCreate](../api/distributed_programming/Cpp/PyInstanceClass-FactoryCreate.rst) API 调用 Python 无状态和有状态函数。
...
我们在 C++ 主程序中使用 [PyFunction](../api/distributed_programming/Cpp/PyFunction.rst) 和 [PyInstanceClass::FactoryCreate](../api/distributed_programming/Cpp/PyInstanceClass-FactoryCreate.rst) API 调用 Java 无状态和有状态函数。
...
我们将 C++ 无状态与有状态函数编译成动态库，在 Java 主程序中使用 [CppFunction](../api/distributed_programming/Java/cpp-function.md) 和 [CppInstanceClass](../api/distributed_programming/Java/cpp_instance_class.md) API 调用。
