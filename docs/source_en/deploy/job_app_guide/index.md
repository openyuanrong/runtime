...
- When calling `YR::Init(const Config &conf)` interface in Driver program, configure [Config](../../multi_language_function_programming_interface/api/distributed_programming/zh_cn/Cpp/struct-Config.rst)'s `loadPaths` parameter.
...
- When calling `init(Config conf)` interface in application program, configure [Config](../../multi_language_function_programming_interface/api/distributed_programming/zh_cn/Java/Config.md)'s `loadPaths` parameter.
