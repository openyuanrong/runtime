...
This API is used to update reserved instance configuration with specific labels for function services in the openYuanrong cluster by calling the meta_service interface.

## Constraints

- The function version must exist.

- The reserved instance configuration must have been created.
...
| maxInstance | String | No | Maximum number of instances. Value range: ``0-1000``. |
| minInstance | String | No | Minimum number of instances. Value range: ``0-1000``. |
...
PUT {[meta service endpoint](api-meta-service-endpoint)}/serverless/v1/functions/reserve-instance
