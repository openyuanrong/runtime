...
// Package server wraps useful methods creating a http server
package server
...
var (
	...
	ErrNoTenantInfo = snerror.New(errmsg.NoTenantInfo, "tenantInfo does not exist")
)
...
type Engine interface {
	...
	Run(addr string, stopCh <-chan struct{}) error
	GraceExit()
