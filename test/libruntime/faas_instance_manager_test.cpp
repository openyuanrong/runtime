...
TEST_F(FaasInstanceManagerTest, GetFaasBatchInstanceRsp)
{
    ...
    std::string json_str =
        removeNewlines(R"({"instanceAllocSucceed":{"f1a00e58-f2a1-4000-8000-000000f8e9e3-thread26":{"funcKey":"123456
78901234561234567890123456/0@functest@functest/latest","funcSig":"4243308021","instanceID":"f1a00e58-f2a1-4000-8000
